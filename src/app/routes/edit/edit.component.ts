...
export class EditComponent implements OnInit {
  ...
  // The configuration object for Forala (https://froala.com/wysiwyg-editor/v1-2/docs/concepts/image-upload/)
  ...
  save(onSucessfulSave) {
    ...
    this.rs.post("/pages/admin/", filteredPage, this.page.url).subscribe(
      (data) => {
